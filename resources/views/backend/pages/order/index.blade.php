                        ...
                        <div class="col-md-12">
                            <div class="card table-card">
                                <div class="card-header">
                                    ...
                                    <h5>Filter Orders</h5>
                                    <form class="d-flex mt-4" method="GET" action="{{ route('admin.order.search') }}">
                                        @csrf
                                ...
                                <div class="card-block">
                                   &nbsp; &nbsp; <form action="{{ route('admin.print.all.view') }}" method="GET" class="d-inline justify-content-end pe-5 me-5 text-right float-lg-end ms-5 ">
                                        ...
                                        {{-- <a href="{{ route('admin.order.pdf',  $array ) }}" class="btn btn-sm btn-success">PDF</a> --}}
                                        <br>
                                        <br>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody class="text-left">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ @$order -> admin -> name ? @$order -> admin -> name : 'No Officer Found' }}</td>
                                                    <td>
